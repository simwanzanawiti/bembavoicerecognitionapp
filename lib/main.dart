  ...
  Future<void> transcribeBemba() async {
    ...
    if (File(recordFilePath).existsSync()) {
      try {
        ...
        // String? textValue;  // Declare as nullable
        // if (jsonResponse.containsKey('text')) {
        //   textValue = jsonResponse['text'];
        // } else if (jsonResponse.containsKey('error')) {
        //   textValue = "The model is still loading... Please wait for 15 seconds";
        // }
        //
        // if (textValue != null) {
        //   setState(() {
        //     transcriptionResponse = textValue!;
        ...
        body: Center(
          child: Column(
            children: [
              ...
              if (showTranscription && transcriptionResponse.isNotEmpty)
                Padding(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.fromLTRB(20, 20, 20, 20),
                      decoration: BoxDecoration(
                          color: transcriptionResponse.isNotEmpty ? bgColor : null, // This line is edited
